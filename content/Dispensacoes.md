...
aliases:
  ...
  - dispensações
dg-metatags:
  description: Análise detalhada do sistema dispensacionalista e o plano de Deus através das eras
tags:
  - Teologia
  - Dispensacionalismo
  - Escatologia
...
O **[[Dispensacionalismo|Dispensacionalismo]]** é um sistema teológico que interpreta a história bíblica como uma série de administrações divinas sucessivas, chamadas "dispensações". O termo deriva do grego *oikonomia* (administração, mordomia ou gestão doméstica). 
...
- A Igreja não substitui Israel; ela é um parêntese no cronograma profético de Deus para a nação hebraica. Ver mais em [[Diferencas-entre-Israel-e-a-igreja-no-Apocalipse|Diferencas-entre-Israel-e-a-igreja-no-Apocalipse]].
...
- [[Manual de Escatologia por Pentecost|Manual de Escatologia por Pentecost]]
- [[Dispensacionalismo|Dispensacionalismo]]
...
- **PENTECOST, J. Dwight**. *Manual de [[Escatologia|Escatologia]]*. Editora Vida.
- **RYRIE, Charles C.** *[[Dispensacionalismo|Dispensacionalismo]]*. Editora Mundo Cristão.
